...
파커는 윤곽을 시작하고 다시 시작하여 두 번째 박자의 약박에 강세를 준다. 그는 #chord("ii") 화음 위에서 C.E.S.H.를 연주하며 #note("Bnat")로 #note("Bb")과 #note("A")로의 해결을 지연시킨다. 두 번째 마디의 강박에서 목표음을 피하고 목표음을 가리키는 두 음을 연주한다. 목표음은 상·하위 이웃음 이후에 들리며 두 번째 마디의 두 번째 박자에 강세를 준다. 두 번째 마디의 네 번째 박자에는 아래로부터 반음계적으로 접근됨으로써 딸림화음의 근음이 강세를 받는다. 세 음이 마지막 목표음 #note("D")를 가리키며, 이는 세 번째 마디의 세 번째 박자에 이르러서야 나타난다. #note("Eb")은 상위 이웃음이고 #note("C")와 #note("C#")은 아래에서 접근한다. 오선 위에 화살표로 표시한 선율의 상위 음들은 단순한 온음계 윤곽을 형성한다. 오선 아래에 화살표로 표시한 하위 음들은 일부 낮은 음들에 의해 암시된 대위선율을 형성하여 복합선율이 된다. 첫 번째 마디의 마지막 음 #note("G")는 #note("G#")으로 상승한 후 두 번째 마디에서 목표음 #note("A")로 이어진다. 두 번째 마디의 마지막 음 #note("A")는 #note("Bb")-#note("C")-#note("C#")으로 상승하여 목표음 #note("D")로 이어진다. 하위 대위선율은 네 번째 박자의 약박에서 시작하여 목표인 3도로 올라가며, 나머지 선율은 내려가는 대칭을 보인다.
...
#exercisebox[
  ...
  +	제2윤곽을 반복하며, 모든 장조와 단조에서 마디선을 넘어 3도를 미리 연주#sub[anticipating]하는 연습을 하라.
    ...
    #align(center)[#autoimg("figures/fig_249.svg")]
]
...
#example("존 콜트레인", 257, subtitle: ["Giant Steps" (_Giant Steps_)])

파커는 이 예시에서 리듬 변화를 추가하고 #note("F")로 향하는 반음계적 접근음을 사용한다.

#example("찰리 파커", 258, subtitle: ["Confirmation" (_Charlie Parker_)])
...
#example([전형적인 라틴 피아노 오스티나토#footnote[동일한 선율의 악구를 계속해서 반복하는 음악적 기법 (역주)]], 274, should-index: false)
...
#example("찰리 파커", 288, subtitle: ["Donna Lee" (_The Complete Savoy Sessions_)])
...
에반스는 빠른 화성 리듬을 가진 이 구절에서 세 개의 윤곽을 사용한다. 제2윤곽은 #maj25 위에, 제3윤곽은 #maj36 위에, 그리고 #chord("Gm")를 8분음표 세 박자 미리 예고하며 제3윤곽은 #prog("ii", "V7/vi", "vi") 위에 연주된다. (이 예시는 예시 181에서도 등장하였다.)
...
#exercisebox[
  ...
  +	제3윤곽을 반복하며, 모든 장조와 단조에서 마디선을 넘어 3도를 미리 연주#sub[anticipating]하는 연습을 하라.
    ...
    #align(center)[#autoimg("figures/fig_300.svg")]
]
...
이 책에서 다룬 대부분의 음악과 예시들은 화성 진행이 있는 음악에 관한 것이다. 그러나 많은 재즈 곡과 즉흥 연주는 모달 구조에 기반을 두고 있다. 모달 음악에 대해 논의할 내용이 많으나, 이는 다른 책에서 다뤄야 할 주제일 것이다.
...
대표적인 모달 곡 녹음본에서 두 가지 예시를 볼 수 있다. 캐넌볼 애덜리는 이 모달 블루스 곡의 솔로에서 제3윤곽의 C.E.S.H. 버전을 여러 번 사용하여 모달적, 동기적, 그리고 블루스적 연주와 대비를 이루었다. 이 윤곽은 G 믹솔리디안 스케일 위에서 연주된다.

#example("캐넌볼 애덜리", 308, subtitle: ["All Blues" (_Kind of Blue_)])
#example("캐넌볼 애덜리", 309, subtitle: ["All Blues" (_Kind of Blue_)])
...
+ 이 16마디 연습곡을 모든 장조에서 연주하라. 각 조에서 편안해질 때까지 반복하라. 목표는 어떤 조에서 시작하든 이 연습곡을 모든 12개의 장조로 전조하여 오류나 망설임 없이 멈추지 않고 연주하는 것이다.
  ...
  #fb[
    ...
    #align(center)[#image("figures/fig_311.svg", width: 100%)]
  ]
...
+ 이 8마디 연습곡을 모든 장조에서 연주하라. 각 조에서 편안해질 때까지 반복하라. 목표는 어떤 조에서 시작하든 이 연습곡을 모든 12개의 장조로 전조하여 오류나 망설임 없이 멈추지 않고 연주하는 것이다.
  ...
  #fb[
    ...
    #align(center)[#image("figures/fig_312.svg", width: 100%)]
  ]
...
+ 다음은 변형된 윤곽을 활용한 연습곡이다.
  ...
  #align(center)[#image("figures/fig_313.svg", width: 100%)]
...
+ 연습곡 1.1\~1.3을 단조에 적용하라. 앞서 말한 대로, 이끎음을 올린 화성 단음계를 사용하라.
  ...
  #fb[
    ...
    #align(center)[#image("figures/fig_314.svg", width: 100%)]
  ]
  #fb[
    2분음표 화성 리듬:

    #align(center)[#image("figures/fig_315.svg", width: 100%)]
  ]
...
#align(center)[#autoimg("figures/fig_316.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("E")단조(#chord("iii"))로 전조:

#align(center)[#autoimg("figures/fig_317.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("F")장조(#chord("IV"))로 전조:

#align(center)[#autoimg("figures/fig_318.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("G")장조(#chord("V"))로 전조:

#align(center)[#autoimg("figures/fig_319.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("A")단조(#chord("vi"))로 전조:

#align(center)[#autoimg("figures/fig_320.svg")]]
...
#align(center)[#autoimg("figures/fig_321.svg")]]
#fb[#note("C")장조(#chord("I"))에서 #note("E")단조(#chord("iii"))로 전조:

#align(center)[#autoimg("figures/fig_322.svg")]]
#fb[#note("C")장조(#chord("I"))에서 #note("F")장조(#chord("IV"))로 전조:

#align(center)[#autoimg("figures/fig_323.svg")]]
#fb[#note("C")장조(#chord("I"))에서 #note("G")장조(#chord("V"))로 전조:

#align(center)[#autoimg("figures/fig_324.svg")]]
#fb[#note("C")장조(#chord("I"))에서 #note("A")단조(#chord("vi"))로 전조:

#align(center)[#autoimg("figures/fig_325.svg")]]
...
#align(center)[#autoimg("figures/fig_326.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("E")단조(#chord("iii"))로 전조:

#align(center)[#autoimg("figures/fig_327.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("F")장조(#chord("IV"))로 전조:

#align(center)[#autoimg("figures/fig_328.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("G")장조(#chord("V"))로 전조:

#align(center)[#autoimg("figures/fig_329.svg")]]

#fb[#note("C")장조(#chord("I"))에서 #note("A")단조(#chord("vi"))로 전조:

#align(center)[#autoimg("figures/fig_330.svg")]]
...
#align(center)[#autoimg("figures/fig_331.svg")]]
#fb[2. 아르페지오 음의 사용
#align(center)[#autoimg("figures/fig_332.svg")]]
#fb[3. 상위 이웃음(UNT)의 반복 사용
#align(center)[#autoimg("figures/fig_333.svg")]]
#fb[4. 이전 연습과 유사하지만 상위 아르페지오 음을 상위 이웃음 대신 사용. 이 선율은 바로크 음악을 연상시킨다.
#align(center)[#autoimg("figures/fig_334.svg")]]
#fb[5. 단순한 기법(둘러싼음과 아르페지오 음)의 조합
#align(center)[#autoimg("figures/fig_335.svg")]]
#fb[6. 상위 및 하위 이웃음(LNT). #chord("G7")과 #chord("CM")의 목표음이 리듬적으로 미리 연주된다.
#align(center)[#autoimg("figures/fig_336.svg")]]
#fb[7. 두 번째 마디에서 3도에서 $flat 9$으로의 도약
#align(center)[#autoimg("figures/fig_337.svg")]]
#fb[8. 픽업음이 포함된 단순한 윤곽
#align(center)[#autoimg("figures/fig_338.svg")]]
#fb[9. 옥타브 이동을 위한 아르페지오 사용, 반음계적 접근, #chord("G7") 화음에서의 이동된 아르페지오
#align(center)[#autoimg("figures/fig_339.svg")]]
#fb[10. 둘러싸기, UNT, 마지막 목표음을 미리 연주
#align(center)[#autoimg("figures/fig_340.svg")]]
#fb[11. 둘러싸기, UNT, 마지막 목표음으로의 반음계적 접근
#align(center)[#autoimg("figures/fig_341.svg")]]
#fb[12. 둘러싸기
#align(center)[#autoimg("figures/fig_342.svg")]]
#fb[13. 더 많은 반음계적 경과음(PT), 차용음, LNT를 사용한 둘러싸기
#align(center)[#autoimg("figures/fig_343.svg")]]
#fb[14. 위와 아래로부터의 반음계적 접근
#align(center)[#autoimg("figures/fig_344.svg")]]
#fb[15. 둘러싸기 (두 번째 마디의 아르페지오는 제1윤곽 중간에 제2윤곽을 암시한다)
#align(center)[#autoimg("figures/fig_345.svg")]]
#fb[16. 반음계적 경과음, C.E.S.H.
#align(center)[#autoimg("figures/fig_346.svg")]]
#fb[17. 반음계적 경과음, 아르페지오 음, C.E.S.H., 둘러싸기
#align(center)[#autoimg("figures/fig_347.svg")]]
#fb[18. 옥타브 이동, 반음계적 접근, 으뜸화음으로의 지연된 해결
#align(center)[#autoimg("figures/fig_348.svg")]]

다음은 단순한 윤곽이 더 복잡한 선율로 변형될 수 있는 방법을 보여준다.

#fb[19. 단순한 윤곽이 일부 리듬적 흥미를 더한 형태로 나타난다.
#align(center)[#autoimg("figures/fig_349.svg")]]
#fb[20. #note("F")가 옥타브 이동되었다.
#align(center)[#autoimg("figures/fig_350.svg")]]
#fb[21. 옥타브를 채우기 위해 아르페지오가 사용되었다.
#align(center)[#autoimg("figures/fig_351.svg")]]
#fb[22. #note("F")가 다시 이동되어 선율에 더 각진 형태를 부여한다.
#align(center)[#autoimg("figures/fig_352.svg")]]
#fb[23. #note("F") 위쪽에서 반음계적 픽업음, #note("B") 아래쪽에서 반음계적 픽업음이 추가되었다.
#align(center)[#autoimg("figures/fig_353.svg")]]
...
#align(center)[#autoimg("figures/fig_354.svg")]]
#fb[2. 음계 구절
#align(center)[#autoimg("figures/fig_355.svg")]]
#fb[3. LNT의 반복 사용
#align(center)[#autoimg("figures/fig_356.svg")]]
#fb[4. LNT, 둘러싸기, 옥타브 이동
#align(center)[#autoimg("figures/fig_357.svg")]]
#fb[5. PT, 아르페지오 음
#align(center)[#autoimg("figures/fig_358.svg")]]
#fb[6. 네 음을 가지고 순환하다 첫 음으로 돌아온다.
#align(center)[#autoimg("figures/fig_359.svg")]]
#fb[7. 음계로부터 온 픽업음
#align(center)[#autoimg("figures/fig_360.svg")]]
#fb[8. 5도로부터 온 픽업음
#align(center)[#autoimg("figures/fig_361.svg")]]
#fb[9. LNT와 확장된 아르페지오, 반음계적 둘러싸기
#align(center)[#autoimg("figures/fig_362.svg")]]
#fb[10. 예기치 않은 반음계적 해결(#note("C")-#note("C#")이 #note("D")로 끌어 올리고, #note("E")-#note("Eb")은 끌어 내린다.), 반음계적 둘러싸기
#align(center)[#autoimg("figures/fig_363.svg")]]
#fb[11. 연속적인 둘러싼음
#align(center)[#autoimg("figures/fig_364.svg")]]
#fb[12. #note("ii") 화음의 근음이 그 딸림화음에 의해 앞서 둘러싸임, 확장된 아르페지오, 둘러싸인 #note("B")
#align(center)[#autoimg("figures/fig_365.svg")]]
...
#align(center)[#autoimg("figures/fig_366.svg")]]
...
#align(center)[#autoimg("figures/fig_367.svg")]]
#fb[2. LNT, 멈췄다 가는 리듬적 느낌
#align(center)[#autoimg("figures/fig_368.svg")]]
#fb[3. LNT, PT, C.E.S.H., 옥타브 이동, 둘러싸기
#align(center)[#autoimg("figures/fig_369.svg")]]
#fb[4. 픽업음, 두 번째 마디까지 지연된 윤곽
#align(center)[#autoimg("figures/fig_370.svg")]]
#fb[5. 반음계적 픽업음, 둘러싼음
#align(center)[#autoimg("figures/fig_371.svg")]]
#fb[6. 반음계적 둘러싼음
#align(center)[#autoimg("figures/fig_372.svg")]]
#fb[7. 둘러싸기, 아르페지오 음, 반음계적 접근음. 첫 마디의 #note("D")에서 #note("F")로 하행 도약이 마지막 마디에서 반복된다.
#align(center)[#autoimg("figures/fig_373.svg")]]
#fb[8. LNT. 리듬적 강세가 때때로 점4분음표 리듬을 암시한다.
#align(center)[#autoimg("figures/fig_374.svg")]]
...
$ chord("ii")-chord("V7")-chord("I")-chord("IV")-underbracket(chord("iihalfdim")-chord("V7"), display(chord("vi")))-chord("vi") $
